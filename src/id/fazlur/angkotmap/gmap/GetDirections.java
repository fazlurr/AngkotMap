package id.fazlur.angkotmap.gmap;

import id.fazlur.angkotmap.MapActivity;
...
public class GetDirections extends AsyncTask<Map<String, String>, Object, ArrayList<LatLng>>
{
    ...
    protected ArrayList<LatLng> doInBackground(Map<String, String>... params)
    {
        ...
        try
        {
            ...
            Document doc = md.getDocument(fromPosition, toPosition, paramMap.get(DIRECTIONS_MODE), waypoints);
